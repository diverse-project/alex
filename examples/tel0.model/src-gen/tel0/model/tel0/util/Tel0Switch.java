 ...
 * @generated
 */
public class Tel0Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Tel0Package modelPackage;
	...
	public Tel0Switch() {
		if (modelPackage == null) {
			modelPackage = Tel0Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Tel0Package.LIT_VAL: {
			LitVal litVal = (LitVal) theEObject;
			T result = caseLitVal(litVal);
			if (result == null)
				result = caseExp(litVal);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lit Val</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lit Val</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLitVal(LitVal object) {
		return null;
	}
