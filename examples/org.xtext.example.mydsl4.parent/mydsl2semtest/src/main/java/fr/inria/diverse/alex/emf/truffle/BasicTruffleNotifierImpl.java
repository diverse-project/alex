 ...
 */
package fr.inria.diverse.alex.emf.truffle;
 ...
 */
public class BasicTruffleNotifierImpl extends Node implements Notifier
{
  /**
   * Creates a blank new instance.
   */
  public BasicTruffleNotifierImpl()
  {
    super();
  }

  /**
   * An interface implemented by {@link BasicTruffleNotifierImpl#eAdapters() adapter lists}
   * that allows {@link BasicTruffleNotifierImpl.EObservableAdapterList.Listener listeners} to observe {@link Adapter adapters} being added and removed.
   * @since 2.6
   */
  public interface EObservableAdapterList
  {
    /**
     * An interface implemented by clients wishing to observe {@link Adapter adapters} being added and removed from an {@link BasicTruffleNotifierImpl#eAdapters() adapter lists}.
     * @since 2.6
     */
    interface Listener
    {
    ...
    protected void didRemove(int index, E oldObject)
    {
      ...
      if (notifier.eDeliver())
      {
        Notification notification = 
          new org.eclipse.emf.common.notify.impl.NotificationImpl(Notification.REMOVING_ADAPTER, oldObject, null, index)
          {
            @Override
