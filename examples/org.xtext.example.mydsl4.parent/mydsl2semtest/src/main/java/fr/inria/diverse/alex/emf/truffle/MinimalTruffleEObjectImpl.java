...
public class MinimalTruffleEObjectImpl extends BasicTruffleEObjectImpl implements EStructuralFeature.Internal.DynamicValueHolder
{
  ...
  {
    class ArrayDelegatingAdapterList extends ArrayDelegatingEList<Adapter> implements BasicTruffleNotifierImpl.EObservableAdapterList
    {
      ...
      {
        newAdapter.setTarget(MinimalTruffleEObjectImpl.this);
        Listener[] listeners = eBasicAdapterListeners();
        if (listeners != null)
        {
          for (Listener listener : listeners)
          {
            listener.added(MinimalTruffleEObjectImpl.this, newAdapter);
          }
        }
      }
      ...
      protected void didRemove(int index, Adapter oldAdapter)
      {
        ...
        if (listeners != null)
        {
          for (Listener listener : listeners)
          {
            listener.removed(MinimalTruffleEObjectImpl.this, oldAdapter);
          }
        }
