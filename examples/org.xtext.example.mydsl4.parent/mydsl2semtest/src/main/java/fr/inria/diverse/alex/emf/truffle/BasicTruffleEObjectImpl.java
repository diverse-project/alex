 ...
 */
public class BasicTruffleEObjectImpl extends BasicTruffleNotifierImpl implements EObject, InternalEObject
{
  /**
   ...
   */
  protected BasicTruffleEObjectImpl() 
  {
    super();
  }
  ...
  public EStructuralFeature.Setting eSetting(final EStructuralFeature eFeature)
  {
    ...
    EStructuralFeature.Setting setting =
      new EStructuralFeature.Setting()
      {
        ...
        {
          return BasicTruffleEObjectImpl.this;
        }
        ...
        {
          return BasicTruffleEObjectImpl.this.eGet(eFeature, resolve);
        }

        public void set(Object newValue)
        {
          BasicTruffleEObjectImpl.this.eSet(eFeature, newValue);
        }

        public boolean isSet()
        {
          return BasicTruffleEObjectImpl.this.eIsSet(eFeature);
        }

        public void unset()
        {
          BasicTruffleEObjectImpl.this.eUnset(eFeature);
        }
      };
    return setting;
  }
  ...
  protected Adapter [] eContainerAdapterArray()
  {
    ...
    return
      eInternalContainer instanceof BasicTruffleEObjectImpl ?
        ((BasicTruffleEObjectImpl)eInternalContainer).eBasicAdapterArray() :
        null;
  }
