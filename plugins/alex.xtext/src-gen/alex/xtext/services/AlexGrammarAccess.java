...
public class AlexGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class AlexRootElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.AlexRoot");
	...
	public class EcoreImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.EcoreImport");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AlexImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.AlexImport");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cImportKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class AlexClassElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.AlexClass");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AlexMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.AlexMethod");
	...
	public class ConcreteMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.ConcreteMethod");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class AbstractMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.AbstractMethod");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DefMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.DefMethod");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OverrideMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "alex.xtext.Alex.OverrideMethod");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("alex.xtext.Alex".equals(grammar.getName())) {
				return grammar;
			}
