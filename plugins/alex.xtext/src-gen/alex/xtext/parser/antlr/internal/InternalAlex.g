...
entryRuleAlexRoot returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAlexRootRule()); }
	iv_ruleAlexRoot=ruleAlexRoot
	{ $current=$iv_ruleAlexRoot.current; }
	EOF;

// Rule AlexRoot
ruleAlexRoot returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAlexImport returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAlexImportRule()); }
	iv_ruleAlexImport=ruleAlexImport
	{ $current=$iv_ruleAlexImport.current; }
	EOF;

// Rule AlexImport
ruleAlexImport returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAlexClass returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAlexClassRule()); }
	iv_ruleAlexClass=ruleAlexClass
	{ $current=$iv_ruleAlexClass.current; }
	EOF;

// Rule AlexClass
ruleAlexClass returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAlexMethod returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAlexMethodRule()); }
	iv_ruleAlexMethod=ruleAlexMethod
	{ $current=$iv_ruleAlexMethod.current; }
	EOF;

// Rule AlexMethod
ruleAlexMethod returns [EObject current=null]
@init {
	enterRule();
}
@after {
