...
import fr.inria.diverse.alex.xtext.ide.contentassist.antlr.AlexParser;
import fr.inria.diverse.alex.xtext.ide.contentassist.antlr.PartialAlexContentAssistParser;
import fr.inria.diverse.alex.xtext.ide.contentassist.antlr.internal.InternalAlexLexer;
import fr.inria.diverse.alex.xtext.ui.contentassist.AlexProposalProvider;
import fr.inria.diverse.alex.xtext.ui.editor.AlexEditor;
import fr.inria.diverse.alex.xtext.ui.labeling.AlexDescriptionLabelProvider;
import fr.inria.diverse.alex.xtext.ui.labeling.AlexLabelProvider;
import fr.inria.diverse.alex.xtext.ui.outline.AlexOutlineTreeProvider;
import fr.inria.diverse.alex.xtext.ui.quickfix.AlexQuickfixProvider;
import fr.inria.diverse.alex.xtext.validation.AlexValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link AlexUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractAlexUiModule extends DefaultXbaseUiModule {

	public AbstractAlexUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(fr.inria.diverse.alex.xtext.parser.antlr.internal.InternalAlexLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return AlexParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalAlexLexer.class).toProvider(LexerProvider.create(InternalAlexLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return AlexValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return AlexLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(AlexDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return AlexOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return AlexQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return AlexProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialAlexContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Alex Compare");
	}
