 ...
 */
package fr.inria.diverse.alex.xtext.serializer;
...
public class AlexSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == AlexPackage.eINSTANCE)
			...
			case AlexPackage.ALEX_CLASS:
				sequence_AlexClass(context, (AlexClass) semanticObject); 
				return; 
			case AlexPackage.ALEX_IMPORT:
				sequence_AlexImport(context, (AlexImport) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     AlexMethod returns AbstractMethod
	...
	/**
	 * Contexts:
	 *     AlexImport returns AlexImport
	 *
	 * Constraint:
	 *     ref=[AlexRoot|ID]
	 */
	protected void sequence_AlexImport(ISerializationContext context, AlexImport semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AlexPackage.Literals.ALEX_IMPORT__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlexPackage.Literals.ALEX_IMPORT__REF));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAlexImportAccess().getRefAlexRootIDTerminalRuleCall_2_0_1(), semanticObject.eGet(AlexPackage.Literals.ALEX_IMPORT__REF, false));
		feeder.finish();
	}
	...
	protected void sequence_EcoreImport(ISerializationContext context, EcoreImport semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AlexPackage.Literals.ECORE_IMPORT__URI) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlexPackage.Literals.ECORE_IMPORT__URI));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	/**
	 * Contexts:
	 *     AlexMethod returns OverrideMethod
