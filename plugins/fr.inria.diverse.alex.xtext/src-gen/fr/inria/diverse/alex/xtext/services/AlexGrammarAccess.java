 ...
 */
package fr.inria.diverse.alex.xtext.services;
...
@Singleton
public class AlexGrammarAccess extends AbstractGrammarElementFinder {
	
	public class AlexRootElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.inria.diverse.alex.xtext.Alex.AlexRoot");
		...
		private final Assignment cCompileTargetAssignment_2_2 = (Assignment)cGroup_2.eContents().get(2);
		private final RuleCall cCompileTargetCompileTargetParserRuleCall_2_2_0 = (RuleCall)cCompileTargetAssignment_2_2.eContents().get(0);
		...
		//('compile' 'as' compileTarget=CompileTarget)?
		...
		public Assignment getCompileTargetAssignment_2_2() { return cCompileTargetAssignment_2_2; }
		
		//CompileTarget
		public RuleCall getCompileTargetCompileTargetParserRuleCall_2_2_0() { return cCompileTargetCompileTargetParserRuleCall_2_2_0; }
	...
	public class CompileTargetElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cTruffleAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final Keyword cTruffleTruffleKeyword_1_0 = (Keyword)cTruffleAssignment_1.eContents().get(0);
		private final Assignment cChildAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final Keyword cChildChildKeyword_2_0 = (Keyword)cChildAssignment_2.eContents().get(0);
		...
		//truffle?='truffle'?
		public Assignment getTruffleAssignment_1() { return cTruffleAssignment_1; }
		
		//'truffle'
		public Keyword getTruffleTruffleKeyword_1_0() { return cTruffleTruffleKeyword_1_0; }
		
		//child?='child'?
		public Assignment getChildAssignment_2() { return cChildAssignment_2; }
		
		//'child'
		public Keyword getChildChildKeyword_2_0() { return cChildChildKeyword_2_0; }
	...
	public class AlexImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.inria.diverse.alex.xtext.Alex.AlexImport");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cImportKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cAlexKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cRefAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final CrossReference cRefAlexRootCrossReference_2_0 = (CrossReference)cRefAssignment_2.eContents().get(0);
		private final RuleCall cRefAlexRootIDTerminalRuleCall_2_0_1 = (RuleCall)cRefAlexRootCrossReference_2_0.eContents().get(1);
		...
		//'alex'
		public Keyword getAlexKeyword_1() { return cAlexKeyword_1; }
		
		//ref=[AlexRoot]
		public Assignment getRefAssignment_2() { return cRefAssignment_2; }
		
		//[AlexRoot]
		public CrossReference getRefAlexRootCrossReference_2_0() { return cRefAlexRootCrossReference_2_0; }
		
		//ID
		public RuleCall getRefAlexRootIDTerminalRuleCall_2_0_1() { return cRefAlexRootIDTerminalRuleCall_2_0_1; }
	}
	public class AlexClassElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.inria.diverse.alex.xtext.Alex.AlexClass");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConcreteMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.inria.diverse.alex.xtext.Alex.ConcreteMethod");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class AbstractMethodElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.inria.diverse.alex.xtext.Alex.AbstractMethod");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public AlexGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.inria.diverse.alex.xtext.Alex".equals(grammar.getName())) {
				return grammar;
			}
	...
	//AlexImport:
	//	'import' 'alex' ref=[AlexRoot];
	public AlexImportElements getAlexImportAccess() {
		return pAlexImport;
	}
	
	public ParserRule getAlexImportRule() {
		return getAlexImportAccess().getRule();
	}
	...
	//AlexMethod:
	//	AbstractMethod | ConcreteMethod;
	public AlexMethodElements getAlexMethodAccess() {
		return pAlexMethod;
	}
	
	public ParserRule getAlexMethodRule() {
		return getAlexMethodAccess().getRule();
	}
