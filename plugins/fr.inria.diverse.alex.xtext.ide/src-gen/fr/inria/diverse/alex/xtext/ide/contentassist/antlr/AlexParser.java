 ...
 */
package fr.inria.diverse.alex.xtext.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import fr.inria.diverse.alex.xtext.ide.contentassist.antlr.internal.InternalAlexParser;
import fr.inria.diverse.alex.xtext.services.AlexGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class AlexParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(AlexGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlexGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAlexMethodAccess().getAlternatives(), "rule__AlexMethod__Alternatives");
	...
	@Override
	protected InternalAlexParser createParser() {
		InternalAlexParser result = new InternalAlexParser(null);
