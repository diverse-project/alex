...
public class BoaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case BoaPackage.BOOL: {
			...
			if (result == null)
				result = caseExpr(bool);
			if (result == null)
				result = caseTopLevelCmd(bool);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.INT: {
			...
			if (result == null)
				result = caseExpr(int_);
			if (result == null)
				result = caseTopLevelCmd(int_);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.SKIP: {
			...
			if (result == null)
				result = caseExpr(skip);
			if (result == null)
				result = caseTopLevelCmd(skip);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.PROJECT: {
			...
			if (result == null)
				result = caseTopLevelCmd(project);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.BOBJECT: {
			...
			if (result == null)
				result = caseExpr(bObject);
			if (result == null)
				result = caseTopLevelCmd(bObject);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BoaPackage.COPY: {
			...
			if (result == null)
				result = caseExpr(copy);
			if (result == null)
				result = caseTopLevelCmd(copy);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.WITH: {
			...
			if (result == null)
				result = caseExpr(with);
			if (result == null)
				result = caseTopLevelCmd(with);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.ARITH_OP: {
			...
			if (result == null)
				result = caseExpr(arithOp);
			if (result == null)
				result = caseTopLevelCmd(arithOp);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BoaPackage.CMP_OP: {
			...
			if (result == null)
				result = caseExpr(cmpOp);
			if (result == null)
				result = caseTopLevelCmd(cmpOp);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.BOOL_OP: {
			...
			if (result == null)
				result = caseExpr(boolOp);
			if (result == null)
				result = caseTopLevelCmd(boolOp);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BoaPackage.ASSIGN: {
			...
			if (result == null)
				result = caseExpr(assign);
			if (result == null)
				result = caseTopLevelCmd(assign);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.ARITH_OP_PLUS: {
			...
			if (result == null)
				result = caseArithOp(arithOpPlus);
			if (result == null)
				result = caseExpr(arithOpPlus);
			if (result == null)
				result = caseTopLevelCmd(arithOpPlus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.ARITH_OP_MINUS: {
			...
			if (result == null)
				result = caseArithOp(arithOpMinus);
			if (result == null)
				result = caseExpr(arithOpMinus);
			if (result == null)
				result = caseTopLevelCmd(arithOpMinus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.ARITH_OP_TIMES: {
			...
			if (result == null)
				result = caseArithOp(arithOpTimes);
			if (result == null)
				result = caseExpr(arithOpTimes);
			if (result == null)
				result = caseTopLevelCmd(arithOpTimes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.ARITH_OP_DIVIDE: {
			...
			if (result == null)
				result = caseArithOp(arithOpDivide);
			if (result == null)
				result = caseExpr(arithOpDivide);
			if (result == null)
				result = caseTopLevelCmd(arithOpDivide);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.ARITH_OP_REMAINDER: {
			...
			if (result == null)
				result = caseArithOp(arithOpRemainder);
			if (result == null)
				result = caseExpr(arithOpRemainder);
			if (result == null)
				result = caseTopLevelCmd(arithOpRemainder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.BOOL_OP_AND: {
			...
			if (result == null)
				result = caseBoolOp(boolOpAnd);
			if (result == null)
				result = caseExpr(boolOpAnd);
			if (result == null)
				result = caseTopLevelCmd(boolOpAnd);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BoaPackage.BOOL_OP_OR: {
			...
			if (result == null)
				result = caseBoolOp(boolOpOr);
			if (result == null)
				result = caseExpr(boolOpOr);
			if (result == null)
				result = caseTopLevelCmd(boolOpOr);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
