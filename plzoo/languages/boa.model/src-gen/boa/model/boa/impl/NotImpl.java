 ...
 * </p>
 * <ul>
 *   <li>{@link boa.model.boa.impl.NotImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotImpl extends ExprImpl implements Not {
	...
	public NotificationChain basicSetValue(Expr newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.NOT__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setValue(Expr newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.NOT__VALUE,
						null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject) newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.NOT__VALUE,
						null, msgs);
