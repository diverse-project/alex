...
public class AssignImpl extends ExprImpl implements Assign {
	...
	public NotificationChain basicSetLhs(Expr newLhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.ASSIGN__LHS,
					oldLhs, newLhs);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLhs(Expr newLhs) {
		if (newLhs != lhs) {
			...
			if (lhs != null)
				msgs = ((InternalEObject) lhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.ASSIGN__LHS,
						null, msgs);
			if (newLhs != null)
				msgs = ((InternalEObject) newLhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.ASSIGN__LHS,
						null, msgs);
	...
	public NotificationChain basicSetRhs(Expr newRhs, NotificationChain msgs) {
		...
		rhs = newRhs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.ASSIGN__RHS,
					oldRhs, newRhs);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRhs(Expr newRhs) {
		if (newRhs != rhs) {
			NotificationChain msgs = null;
			if (rhs != null)
				msgs = ((InternalEObject) rhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.ASSIGN__RHS,
						null, msgs);
			if (newRhs != null)
				msgs = ((InternalEObject) newRhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.ASSIGN__RHS,
						null, msgs);
