 ...
 * </p>
 * <ul>
 *   <li>{@link boa.model.boa.impl.FunImpl#getName <em>Name</em>}</li>
 *   <li>{@link boa.model.boa.impl.FunImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunImpl extends ExprImpl implements Fun {
	...
	public NotificationChain basicSetBody(Expr newBody, NotificationChain msgs) {
		...
		body = newBody;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.FUN__BODY,
					oldBody, newBody);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBody(Expr newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject) body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.FUN__BODY,
						null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject) newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.FUN__BODY,
						null, msgs);
