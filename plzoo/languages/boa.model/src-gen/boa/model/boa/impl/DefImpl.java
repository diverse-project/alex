 ...
 * </p>
 * <ul>
 *   <li>{@link boa.model.boa.impl.DefImpl#getName <em>Name</em>}</li>
 *   <li>{@link boa.model.boa.impl.DefImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefImpl extends TopLevelCmdImpl implements Def {
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		expr = newExpr;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.DEF__EXPR,
					oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setExpr(Expr newExpr) {
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.DEF__EXPR,
						null, msgs);
			if (newExpr != null)
				msgs = ((InternalEObject) newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.DEF__EXPR,
						null, msgs);
