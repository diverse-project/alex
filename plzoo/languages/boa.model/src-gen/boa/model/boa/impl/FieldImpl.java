 ...
 * </p>
 * <ul>
 *   <li>{@link boa.model.boa.impl.FieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link boa.model.boa.impl.FieldImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldImpl extends MinimalEObjectImpl.Container implements Field {
	...
	public NotificationChain basicSetValue(Expr newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.FIELD__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setValue(Expr newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.FIELD__VALUE,
						null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject) newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.FIELD__VALUE,
						null, msgs);
