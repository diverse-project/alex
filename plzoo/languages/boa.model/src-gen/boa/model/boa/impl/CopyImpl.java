 ...
 * </p>
 * <ul>
 *   <li>{@link boa.model.boa.impl.CopyImpl#getCopy <em>Copy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CopyImpl extends ExprImpl implements Copy {
	...
	public NotificationChain basicSetCopy(Expr newCopy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BoaPackage.COPY__COPY,
					oldCopy, newCopy);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCopy(Expr newCopy) {
		if (newCopy != copy) {
			...
			if (copy != null)
				msgs = ((InternalEObject) copy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BoaPackage.COPY__COPY,
						null, msgs);
			if (newCopy != null)
				msgs = ((InternalEObject) newCopy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BoaPackage.COPY__COPY,
						null, msgs);
