 ...
 * </p>
 * <ul>
 *   <li>{@link boa.model.boa.Copy#getCopy <em>Copy</em>}</li>
 * </ul>
 *
 * @see boa.model.boa.BoaPackage#getCopy()
 * @model
 * @generated
 */
public interface Copy extends Expr {
	 ...
	 * @see #setCopy(Expr)
	 * @see boa.model.boa.BoaPackage#getCopy_Copy()
	...
	/**
	 * Sets the value of the '{@link boa.model.boa.Copy#getCopy <em>Copy</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
