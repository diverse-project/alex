 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.model.petrinet.impl.TransitionImpl#getMinTime <em>Min Time</em>}</li>
 *   <li>{@link petrinet.model.petrinet.impl.TransitionImpl#getMaxTime <em>Max Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends NodeImpl implements Transition {
	...
	public void setMinTime(int newMinTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.TRANSITION__MIN_TIME, oldMinTime,
					minTime));
	}
	...
	public void setMaxTime(int newMaxTime) {
		...
		maxTime = newMaxTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.TRANSITION__MAX_TIME, oldMaxTime,
					maxTime));
	}
