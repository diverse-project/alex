 ...
 */
package fr.mleduc.lang.boa.serializer;
...
public class BoaSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ExecboatrufflePackage.eINSTANCE)
	...
	protected void sequence_App(ISerializationContext context, App semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.APP__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.APP__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.APP__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.APP__RHS));
		}
	...
	protected void sequence_ArithOpDivide(ISerializationContext context, ArithOpDivide semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.ARITH_OP__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.ARITH_OP__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.ARITH_OP__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.ARITH_OP__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Assign(ISerializationContext context, Assign semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.ASSIGN__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.ASSIGN__NAME));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.ASSIGN__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.ASSIGN__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.ASSIGN__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.ASSIGN__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BoolOpAnd(ISerializationContext context, BoolOpAnd semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_AND__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_AND__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_AND__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_AND__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BoolOpOr(ISerializationContext context, BoolOpOr semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_OR__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_OR__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_OR__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.BOOL_OP_OR__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_CmpOpEqual(ISerializationContext context, CmpOpEqual semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.CMP_OP__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.CMP_OP__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.CMP_OP__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.CMP_OP__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Copy(ISerializationContext context, Copy semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.COPY__COPY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.COPY__COPY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Def(ISerializationContext context, Def semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.DEF__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.DEF__NAME));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.DEF__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.DEF__EXPR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Field(ISerializationContext context, Field semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.FIELD__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.FIELD__NAME));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.FIELD__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.FIELD__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Fun(ISerializationContext context, Fun semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.FUN__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.FUN__NAME));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.FUN__BODY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.FUN__BODY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_If(ISerializationContext context, If semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.IF__COND) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.IF__COND));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.IF__THEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.IF__THEN));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.IF__ELS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.IF__ELS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getIfAccess().getCondExprParserRuleCall_3_0(), semanticObject.getCond());
		feeder.accept(grammarAccess.getIfAccess().getThenExprParserRuleCall_5_0(), semanticObject.getThen());
	...
	protected void sequence_Let(ISerializationContext context, Let semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.LET__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.LET__NAME));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.LET__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.LET__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.LET__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.LET__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Not(ISerializationContext context, Not semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.NOT__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.NOT__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Project(ISerializationContext context, Project semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.PROJECT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.PROJECT__NAME));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.PROJECT__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.PROJECT__EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Seq(ISerializationContext context, Seq semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.SEQ__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.SEQ__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.SEQ__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.SEQ__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Var(ISerializationContext context, Var semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.VAR__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.VAR__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_With(ISerializationContext context, With semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.WITH__LHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.WITH__LHS));
			if (transientValues.isValueTransient(semanticObject, ExecboatrufflePackage.Literals.WITH__RHS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExecboatrufflePackage.Literals.WITH__RHS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
