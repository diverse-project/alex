...
public class InternalBoaParser extends AbstractInternalContentAssistParser {
    ...
    // InternalBoa.g:3460:1: rule__If__Group__5__Impl : ( ( rule__If__ThenAssignment_5 ) ) ;
    public final void rule__If__Group__5__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalBoa.g:3464:1: ( ( ( rule__If__ThenAssignment_5 ) ) )
            // InternalBoa.g:3465:1: ( ( rule__If__ThenAssignment_5 ) )
            {
            // InternalBoa.g:3465:1: ( ( rule__If__ThenAssignment_5 ) )
            // InternalBoa.g:3466:2: ( rule__If__ThenAssignment_5 )
            {
             before(grammarAccess.getIfAccess().getThenAssignment_5()); 
            // InternalBoa.g:3467:2: ( rule__If__ThenAssignment_5 )
            // InternalBoa.g:3467:3: rule__If__ThenAssignment_5
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalBoa.g:6719:1: rule__If__ThenAssignment_5 : ( ruleExpr ) ;
    public final void rule__If__ThenAssignment_5() throws RecognitionException {
        ...
        try {
            ...
            {
             before(grammarAccess.getIfAccess().getThenExprParserRuleCall_5_0()); 
            pushFollow(FOLLOW_2);
            ruleExpr();

            state._fsp--;

             after(grammarAccess.getIfAccess().getThenExprParserRuleCall_5_0()); 
