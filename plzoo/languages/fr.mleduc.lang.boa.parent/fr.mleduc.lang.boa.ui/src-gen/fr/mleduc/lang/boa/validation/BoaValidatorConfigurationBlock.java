 ...
 */
package fr.mleduc.lang.boa.validation;
...
public class BoaValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(BoaConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Boa");
		if (section == null) {
			return dialogSettings.addNewSection("Boa");
		}
		return section;
	}
}
